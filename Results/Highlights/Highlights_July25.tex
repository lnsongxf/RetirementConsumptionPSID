...
\subsection{Regression table with nondurables expenditure}
\input{../Regression_Table/Def_1/By_tertile_test_nond_expenditure_categories_1.tex}


\clearpage

\subsection{Regression table with nondurables expenditure w/o health expenditure} 
\input{../Regression_Table/Def_1/By_tertile_test_nond_expenditure_categories_2.tex}
\clearpage

\subsection{Regression table with nondurables expenditure without Health and Education Expenditure}
\input{../Regression_Table/Def_1/By_tertile_test_nond_expenditure_categories_3.tex}
\clearpage
...
%\begin{table}[h]
%	\centering
%	\input{../Regression_Table/Interaction/Deff_1/1_test_total_foodexp_home_real.tex}
%\end{table}
