...
keep pid wave family_id rel2head age sex_indiv children fsize ///
 hours_annual_female inc_head inc_fam inc_spouse inc_fam_nofemale ///
...
race_indiv wage_rate_male household_nonlabor_income emp_status_1 emp_status_2 emp_status_3 ///
