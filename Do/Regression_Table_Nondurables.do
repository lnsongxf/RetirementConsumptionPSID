	...
	* edit pid wave retired do_they_ever_retire if do_they_ever_retire == 1 & pid == 11003
	...
	/*	
		...
		* ssc install esttab
		...
		qui xtreg `var' i.tertile i.retired#i.tertile
		outreg2 using "$folder_output/NO_FE/Deff_`spouse_def'/test_`var'.tex", ctitle("test 2") tex(frag) addtext(HH FE, Yes, Age Dummies, No, Dummy Children, No, Time, No) nocons keep(1.retired#1b.tertile 1.retired#2.tertile 1.retired#3.tertile 2.tertile 3.tertile)

		qui xtreg `var' i.age i.tertile i.retired#i.tertile
		outreg2 using "$folder_output/NO_FE/Deff_`spouse_def'/test_`var'.tex", ctitle("test 3") tex(frag) addtext(HH FE, No, Age Dummies, Yes, Dummy Children, No, Time, No) nocons keep(1.retired#1b.tertile 1.retired#2.tertile 1.retired#3.tertile 2.tertile 3.tertile)

		qui xtreg `var' i.age i.tertile i.retired#i.tertile i.dummy_children
		outreg2 using "$folder_output/NO_FE/Deff_`spouse_def'/test_`var'.tex", ctitle("test 4") tex(frag) addtext(HH FE, No, Age Dummies, Yes, Dummy Children, Yes, Time, No) nocons keep(1.retired#1b.tertile 1.retired#2.tertile 1.retired#3.tertile 2.tertile 3.tertile)
	...
	* edit pid wave retired do_they_ever_retire if do_they_ever_retire == 1 & pid == 11003
		...
		outreg2 using "$folder_output/NO_FE/Deff_`spouse_def'/test_`var'.tex", ctitle("test 6") tex(frag) addtext(HH FE, No, Age Dummies, No, Dummy Children, No, Time, No) nocons keep(1.retired#1b.tertile 1.retired#2.tertile 1.retired#3.tertile 2.tertile 3.tertile)

		qui xtreg `var' i.tertile i.retired#i.tertile `conditions'
		outreg2 using "$folder_output/NO_FE/Deff_`spouse_def'/test_`var'.tex", ctitle("test 7") tex(frag) addtext(HH FE, No, Age Dummies, No, Dummy Children, No, Time, No) nocons keep(1.retired#1b.tertile 1.retired#2.tertile 1.retired#3.tertile 2.tertile 3.tertile)

		qui xtreg `var' i.age i.tertile i.retired#i.tertile `conditions'
		outreg2 using "$folder_output/NO_FE/Deff_`spouse_def'/test_`var'.tex", ctitle("test 8") tex(frag) addtext(HH FE, Yes, Age Dummies, Yes, Dummy Children, No, Time, No) nocons keep(1.retired#1b.tertile 1.retired#2.tertile 1.retired#3.tertile 2.tertile 3.tertile)

		qui xtreg `var' i.age i.tertile i.retired#i.tertile i.dummy_children `conditions'
		outreg2 using "$folder_output/NO_FE/Deff_`spouse_def'/test_`var'.tex", ctitle("test 9") tex(frag) addtext(HH FE, Yes, Age Dummies, Yes, Dummy Children, Yes, Time, No) nocons keep(1.retired#1b.tertile 1.retired#2.tertile 1.retired#3.tertile 2.tertile 3.tertile)

		qui xtreg `var' i.age i.tertile i.retired#i.tertile i.dummy_children d_year* `conditions'
		outreg2 using "$folder_output/NO_FE/Deff_`spouse_def'/test_`var'.tex", ctitle("test 10") tex(frag) addtext(HH FE, Yes, Age Dummies, Yes, Dummy Children, Yes, Time, Yes)  nocons  keep(1.retired#1b.tertile 1.retired#2.tertile 1.retired#3.tertile 2.tertile 3.tertile)

* This is the section for No Fixed Effect, No Children Dummy, No, Time Dummy, No 
...
*/
	* edit pid wave retired do_they_ever_retire if do_they_ever_retire == 1 & pid == 11003
		...
		qui reg `var' i.tertile i.retired#i.tertile `conditions'
		outreg2 using "$folder_output/NO_FE/Deff_`spouse_def'/test_`var'.tex", ctitle("OLS") tex(frag) replace addtext(HH FE, No, Age Dummies, No, Dummy Children, No, Time, No) nocons keep(1.retired#1b.tertile 1.retired#2.tertile 1.retired#3.tertile 2.tertile 3.tertile)
