	...
	***********************************************************************************
		...
		* New Version : error bands computed correctly
		...
		/*
			...
			graph export "$folder/Results/ConsumptionPostRetirement_by_SpouseDef_Cats/Comparision/'spouse_def'_SmoothedvsUnsmoothed_`var'.pdf", as(pdf) replace
		*/
			*This is smoothed version
